...
namespace MessagePack.Resolvers
{
    ...
    internal static class GeneratedResolverGetFormatterHelper
    {
        ...
        static GeneratedResolverGetFormatterHelper()
        {
            ...
            {
                { typeof(global::Shared.Interfaces.StreamingHubs.JoinedUser), 0 },
                { typeof(global::Shared.Model.Entity.DeadData), 1 },
                { typeof(global::Shared.Model.Entity.HitData), 2 },
                { typeof(global::Shared.Model.Entity.MoveData), 3 },
                { typeof(global::Shared.Model.Entity.ResultData), 4 },
                { typeof(global::Shared.Model.Entity.ThrowData), 5 },
                { typeof(global::Shared.Model.Entity.User), 6 },
                { typeof(global::Shared.Model.Entity.UserState), 7 },
            };
        }
        ...
        internal static object GetFormatter(global::System.Type t)
        {
            ...
            switch (key)
            {
                case 0: return new MessagePack.Formatters.Shared.Interfaces.StreamingHubs.JoinedUserFormatter();
                case 1: return new MessagePack.Formatters.Shared.Model.Entity.DeadDataFormatter();
                case 2: return new MessagePack.Formatters.Shared.Model.Entity.HitDataFormatter();
                case 3: return new MessagePack.Formatters.Shared.Model.Entity.MoveDataFormatter();
                case 4: return new MessagePack.Formatters.Shared.Model.Entity.ResultDataFormatter();
                case 5: return new MessagePack.Formatters.Shared.Model.Entity.ThrowDataFormatter();
                case 6: return new MessagePack.Formatters.Shared.Model.Entity.UserFormatter();
                case 7: return new MessagePack.Formatters.Shared.Model.Entity.UserStateFormatter();
                default: return null;
            }
        }
    }
...
namespace MessagePack.Formatters.Shared.Interfaces.StreamingHubs
{
    public sealed class JoinedUserFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Shared.Interfaces.StreamingHubs.JoinedUser>
    {
        ...
        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Shared.Interfaces.StreamingHubs.JoinedUser value, global::MessagePack.MessagePackSerializerOptions options)
        {
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::Shared.Model.Entity.UserState>(formatterResolver).Serialize(ref writer, value.UserState, options);
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        ____result.UserState = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::Shared.Model.Entity.UserState>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    case 3:
...
{
    public sealed class DeadDataFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Shared.Model.Entity.DeadData>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Shared.Model.Entity.DeadData value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            writer.Write(value.ThrowNum);
            writer.Write(value.HitNum);
            writer.Write(value.CatchNum);
            writer.Write(value.JoinOrder);
            writer.Write(value.IsLast);
        }

        public global::Shared.Model.Entity.DeadData Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
                return null;
            ...
            global::MessagePack.IFormatterResolver formatterResolver = options.Resolver;
            var length = reader.ReadArrayHeader();
            var ____result = new global::Shared.Model.Entity.DeadData();
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        ____result.Time = reader.ReadInt32();
                        break;
                    case 4:
                        ____result.ThrowNum = reader.ReadInt32();
                        break;
                    case 5:
                        ____result.HitNum = reader.ReadInt32();
                        break;
                    case 6:
                        ____result.CatchNum = reader.ReadInt32();
                        break;
                    case 7:
                        ____result.JoinOrder = reader.ReadInt32();
                        break;
                    case 8:
                        ____result.IsLast = reader.ReadBoolean();
                        break;
                    default:
                        reader.Skip();
                        break;
    ...
    public sealed class HitDataFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Shared.Model.Entity.HitData>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Shared.Model.Entity.HitData value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::System.Guid>(formatterResolver).Serialize(ref writer, value.ConnectionId, options);
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::System.Guid>(formatterResolver).Serialize(ref writer, value.EnemyId, options);
            writer.Write(value.DamagedHP);
            writer.Write(value.Point);
        }

        public global::Shared.Model.Entity.HitData Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
                return null;
            ...
            global::MessagePack.IFormatterResolver formatterResolver = options.Resolver;
            var length = reader.ReadArrayHeader();
            var ____result = new global::Shared.Model.Entity.HitData();
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        ____result.EnemyId = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::System.Guid>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    case 2:
                        ____result.DamagedHP = reader.ReadInt32();
                        break;
                    case 3:
                        ____result.Point = reader.ReadInt32();
                        break;
    ...
    public sealed class ThrowDataFormatter : global::MessagePack.Formatters.IMessagePackFormatter<global::Shared.Model.Entity.ThrowData>
    {

        public void Serialize(ref global::MessagePack.MessagePackWriter writer, global::Shared.Model.Entity.ThrowData value, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (value == null)
            {
                writer.WriteNil();
            ...
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::System.Guid>(formatterResolver).Serialize(ref writer, value.ConnectionId, options);
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::UnityEngine.Vector3>(formatterResolver).Serialize(ref writer, value.ThorwPos, options);
            global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::UnityEngine.Vector3>(formatterResolver).Serialize(ref writer, value.GoalPos, options);
        }

        public global::Shared.Model.Entity.ThrowData Deserialize(ref global::MessagePack.MessagePackReader reader, global::MessagePack.MessagePackSerializerOptions options)
        {
            if (reader.TryReadNil())
            {
                return null;
            ...
            global::MessagePack.IFormatterResolver formatterResolver = options.Resolver;
            var length = reader.ReadArrayHeader();
            var ____result = new global::Shared.Model.Entity.ThrowData();
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    case 0:
                        ...
                        break;
                    case 1:
                        ____result.ThorwPos = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::UnityEngine.Vector3>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    case 2:
                        ____result.GoalPos = global::MessagePack.FormatterResolverExtensions.GetFormatterWithVerify<global::UnityEngine.Vector3>(formatterResolver).Deserialize(ref reader, options);
                        break;
                    default:
                        reader.Skip();
                        break;
            ...
            for (int i = 0; i < length; i++)
            {
                switch (i)
                {
                    ...
                    case 4:
                        ...
                        break;
                    case 5:
                        ____result.Life = reader.ReadInt32();
                        break;
                    case 6:
